...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :chef_solo do |chef|
    ...
    chef.run_list = [
      ...
      #'recipe[cbmysqlr1::default]', 'recipe[cbmysqlr1::install_rpms]', 'recipe[cbmysqlr1::secure_installation]', 'recipe[cbmysqlr1::create_dirs_files]', 'recipe[cbmysqlr1::create_server_cnf]', 'recipe[cbmysqlr1::create_db_hr]'
      #
      #
      # This line onwards are custom ones
      #'recipe[cbmysqlr1::create_db_hr]'
      #'recipe[cbmysqlr1::create_server_cnf]', 'recipe[cbmysqlr1::create_db_hr]'
